...
//@non-generated-start[createBindingStructure-table]
    ...
    withCellHeight:@(200)
    withCellBindingFormat:@"outlet.componentView.binding : c.data<->vm.mVMReportDetailPanel.selectedMVMReportDetailPanelCustomerItem", 
	@"outlet.componentView.associatedLabel : outlet.label", 
	@"outlet.label.binding : c.data<-i18n.reportdetailpanel__MVMReportDetailPanelCustomer__label", @"outlet.componentView.attributes : selectedItemBindingDelegate=ReportDetailPanelCustomerSelectedItemBindingDelegate, search=false, listItemBindingDelegate=ReportDetailPanelCustomerListItemBindingDelegate, pickerValuesKey=lstMVMReportDetailPanelCustomer, ",
     nil];
    ...
    [MFBindingCellDescriptor cellDescriptorWithIdentifier:@"CustomerExpensePanelInfosCell"
    withCellHeight:@(84)
    withCellBindingFormat:@"outlet.date.binding : c.data<->vm.mVMReportDetailPanel.date", @"outlet.date.attributes : dateTimeMode=0 ", @"outlet.reason.binding : c.data<->vm.mVMReportDetailPanel.reason", @"outlet.reason.attributes : mandatory=NO ", @"outlet.amount.binding : c.data<->vm.mVMReportDetailPanel.humanReadableAmount", @"outlet.amount.attributes : editable=NO, ",
     nil];
    ...
    withCellHeight:@(483)
    withCellBindingFormat:@"outlet.componentView.binding : c.data<->vm.mVMReportDetailPanel.mVMReportDetailPanelExpensesList", 
	@"outlet.componentView.associatedLabel : outlet.label", 
	@"outlet.label.binding : c.data<-i18n.reportdetailpanel__MVMReportDetailPanelExpensesList__label", @"outlet.componentView.attributes : mandatory=NO, canDelete=YES, canSelect=YES, dataDelegate=ReportDetailPanelExpensesView, canMove=NO, ", 
     nil];
