...
-(void) createBindingStructure {
    ...
    [MFBindingCellDescriptor cellDescriptorWithIdentifier:@"MDKPickerListCell"
                                           withCellHeight:@(41)
                                    withCellBindingFormat:@"outlet.componentView.binding : c.data<->vm.selectedMVMReportDetailPanelTypeItem",
     @"outlet.componentView.associatedLabel : outlet.label",
     @"outlet.label.binding : c.data<-i18n.expenseType", @"outlet.componentView.attributes : selectedItemBindingDelegate=ExpensesTypeSelectedItemBindingDelegate, search=false, listItemBindingDelegate=ExpensesTypeListItemBindingDelegate, pickerValuesKey=lstMVMReportDetailPanelType, ",
     nil];
    [tableConfiguration createTableCellWithDescriptor:MReportDetailPanelExpensesItemDetailController_MVMReportDetailPanelTypeEditCellDescriptor];
    ...
    [MFBindingCellDescriptor cellDescriptorWithIdentifier:@"MDKEnumImageCell-noLabel"
                                           withCellHeight:@(70)
                                    withCellBindingFormat:@" outlet.componentView.binding : c.data<->vm.state", @"outlet.componentView.attributes : editable=NO, enumClassName=MExpenseState, ",
     nil];
...
//@non-generated-start[others-methods]
...
-(void) didReceiveClassNotification:(NSNotification *)classNotification {
    ...
    if([classNotification.identifier isEqualToString:@"expenseStateVisibility"]) {
        ...
        MFBindingAbstractDescriptor *descriptor = [self bindingDescriptorAtIndexPath:[NSIndexPath indexPathForRow:4 inSection:0]];
