...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            {pattern: 'build/vendor/mdk-html5-lib-core/lib/mfcoreModule.js', watched: false},
            {pattern: 'build/vendor/mdk-html5-lib-ui/lib/mfuiModule.js', watched: false},
            'build/vendor/mdk-html5-lib-ui/lib/**.js',
            'build/vendor/mdk-html5-lib-ui/lib/**/*.js',
            'build/vendor/mdk-html5-lib-core/lib/**.js',
            'build/vendor/mdk-html5-lib-core/lib/**/*.js',
